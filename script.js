...
const ARTICLES = [
  { date:"2026.09",
  url: "https://mp.weixin.qq.com/s/f1-8paEYeuLH8WQVBT9b-g",
  zh: {tag: "剧集 · 剧评", t: "Netflix《百年孤独》剧评", d: "评这部网飞改编剧如何在宏大的影像叙事中，守住马尔克斯经典的文学灵魂与哥伦比亚本土性。"},
  en: {tag: "TV · Review", t: "One Hundred Years of Solitude — A Review", d: "On how Netflix’s adaptation preserves the literary spirit and Colombian identity of García Márquez’s classic."},
  kind:"film", featured:true },
  { date:"2026.09",
  url: "https://mp.weixin.qq.com/s/Wc_c70UqosT75atHAvn46A",
  zh: { tag: "电影 · 影评", t: "美国电影《激情邀约》影评", d: "评影片如何借一场交换伴侣的邀约，剖析中年婚姻的危机。"},
  en: { tag: "Film · Review", t: "The Invite — A Review", d: "On how a partner-swapping invitation exposes the crisis of a middle-aged marriage."},
  kind:"film", featured:true },
  {   date: "2026.08",
  url: "https://mp.weixin.qq.com/s/JqYyRlIQ9jXQyx-hhpQxqg",
  zh: {tag: "动画 · 剧评",t: "《瑞克和莫蒂》第九季剧评", d:"评第九季的口碑为何可以重回高峰。"},
  en: {tag: "Animation · TV Review",  t: "Rick and Morty Season 9 — A Review", d: "Exploring why the ninth season marks a return to critical acclaim for the series."},
  kind: "animation",featured: false},
  { date:"2026.08", url:"https://mp.weixin.qq.com/s/E9Pm6eEFHG_Pek0oJ-wpaw",
    zh:{tag:"演员 · 侧写", t:"赞达亚之年：一个ICON的崛起", d:"回顾赞达亚的成名之路，探讨她为何可以成为新世代演员的ICON。"},
    en:{tag: "Actor · Profile", t: "The Year of Zendaya: The Rise of a New Icon", d: "Tracing Zendaya’s path to stardom and exploring why she has become an icon for a new generation of actors."},
    kind:"people", featured:true },
  { date:"2026.08", url:"https://mp.weixin.qq.com/s/mhEcONn0RxWtscOzBkthtg",
    zh:{tag:"法国动画 · 影评", t:"法国动画《我住在凡尔赛的日子》评论", d:"介绍这部法国动画，并讨论故事中的恐袭创伤修复的主题，以及浅谈法国动画的发展现状。"},
    en:{tag:"French Animation · Review", t:"My Life in Versailles — a film review", d:"A review of this French animated film, and a brief exploration of the current state of French animation."},
    kind:"film", featured:false },
  { date:"2026.08", url:"https://mp.weixin.qq.com/s/Vs-FRxEgkafXzyfA0BQ-wg",
    zh:{tag:"导演 · 侧写", t:"克里斯托弗·诺兰的电影世界", d:"回顾诺兰的电影人生，评述他的作者风格。"},
    en:{tag:"Director · Profile", t:"Inside Christopher Nolan’s Cinematic Mind", d:"A long-form profile of Christopher Nolan, tracing the filmmaker’s obsession with time, spectacle, and practical cinema."},
    pub:{zh:"剧焦", en:"Drama Focus"},
    kind:"people", featured:true },
  ...
  { date:"2025.08", url:"https://www.lifeweek.com.cn/article/252183",
    zh:{tag:"动画 · 回顾", t:"《瑞克和莫蒂》八季回顾", d:"回望这部美国热门动画剧集横跨八季的演变与文化位置。"},
...
const I18N = {
  zh: {
    ...
    "hero.title":"在银幕<br>与舞台之间，<br>看见更大的世界。",
    ...
    "hero.stat1.k":"发表长文","hero.stat1.v":"《三联生活周刊》36 篇",
    ...
    "about.p2":"我关注艺术电影与独立创作，也追踪主流剧集与动画——从韩国、日本、华语的作者电影，到好莱坞奥斯卡话题作、热门剧集与精品动画，再到剧场与高清影像。除了写字，我和另一位电影媒体人共同主理播客「袭击电影院」。",
    ...
    "work.readlink":"阅读全文 →",
    "writing.title":"新媒体写作",
    "writing.intro":"按时间排列的文章列表，主要发表于《三联生活周刊》官方微信公众号，也包括《剧焦》等媒体稿件。此列表持续更新。",
    "writing.pub":"三联生活周刊",
    "print.title":"杂志专栏",
  ...
  en: {
    ...
    "hero.stat1.k":"Long-form pieces","hero.stat1.v":"36 in Sanlian Lifeweek",
    ...
    "print.title":"Print Reviews · Column",
