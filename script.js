...
const ARTICLES = [
  { date:"2026.07", url:"https://mp.weixin.qq.com/s/4k0hjKCfp2JVGQ-WQ3YfJg?scene=1",
    zh:{tag:"戏剧 · 剧评", t:"话剧《我们成为的她》剧评（梁咏琪主演）", d:"评梁咏琪主演的话剧《我们成为的她》——改编自韩国现象级小说《82年生的金智英》，谈舞台转译与女性叙事。"},
    en:{tag:"Theatre · Review", t:"The Woman We Become — a stage review (starring Gigi Leung)", d:"On the play starring Gigi Leung, adapted from the phenomenal Korean novel Kim Ji-young, Born 1982 — stage translation and female narrative."},
  ...
  { date:"2026.06", url:"https://www.lifeweek.com.cn/article/269488",
    zh:{tag:"韩国电影 · 影评", t:"《与王生活的男人》：一部韩国电影的长评", d:"从类型与作者性切入，评析这部韩国新片的叙事野心与完成度。"},
  ...
  { date:"2026.05", url:"https://www.lifeweek.com.cn/article/266745",
    zh:{tag:"韩国电影 · 影评", t:"《世界的主人》：一部韩国电影的批评", d:"关于情感、类型与当代韩国电影语法的一次细读。"},
  ...
  { date:"2026.04", url:"https://www.lifeweek.com.cn/article/265994",
    zh:{tag:"英国剧集 · 剧评", t:"《真相捕捉》第三季评论", d:"评这部英国剧集的第三季，谈监控、深伪技术与真相的政治。"},
  ...
  { date:"2026.03", url:"https://www.lifeweek.com.cn/article/264044",
    zh:{tag:"美国电影 · 特写", t:"《至尊马蒂》与提莫西·查拉梅特写", d:"以一部美国电影为切口，解读查拉梅的表演与明星形象建构。"},
  ...
  { date:"2026.03", url:"https://www.lifeweek.com.cn/article/263755",
    zh:{tag:"英国剧场 · NT Live", t:"NT Live《非穷尽列举》剧评", d:"评英国国家剧院现场影像作品，谈舞台影像的批评视角。"},
    en:{tag:"British Theatre · NT Live", t:"National Theatre Live: Inter Alia", d:"A review of the NT Live production — a critical lens on theatre-on-screen."},
    kind:"drama", featured:false },
  { date:"2026.03", url:"https://www.lifeweek.com.cn/article/263616",
    zh:{tag:"英国剧集 · 剧评", t:"英剧《强制窃贼》评论", d:"评这部 Prime 英国剧集，谈犯罪类型与叙事张力。"},
  ...
  { date:"2026.02", url:"https://www.lifeweek.com.cn/article/263154",
    zh:{tag:"英国剧集 · 剧评", t:"《夜班经理》第二季评论", d:"评这部英国剧集的续作，谈改编、谍战类型与角色回归。"},
  ...
  { date:"2025.11", url:"https://www.lifeweek.com.cn/article/255931",
    zh:{tag:"美国剧集 · 剧评", t:"《大楼里只有谋杀》第五季评论", d:"评这部 Hulu 剧集的第五季，谈推理喜剧的延续与自我更新。"},
  ...
  { date:"2025.10", url:"https://www.lifeweek.com.cn/article/263928",
    zh:{tag:"奥斯卡 · 深度", t:"奥斯卡获奖片《一战再战》深度分析", d:"深度解读这部奥斯卡获奖美国电影的形式、主题与获奖语境。"},
  ...
  { date:"2025.10", url:"https://www.lifeweek.com.cn/article/254453",
    zh:{tag:"日本动画剧 · 评论", t:"日本动画《小城日常》评论", d:"评这部日本动画剧集，谈日常喜剧与小城生活的质感。"},
  ...
  { date:"2025.07", url:"https://www.lifeweek.com.cn/article/250360",
    zh:{tag:"美国剧集 · 影评", t:"美国热门剧集《匹兹堡医护前线》评论", d:"评这部美国高口碑剧集，谈实时叙事与职业剧的当代形态。"},
  ...
  { date:"2025.07", url:"https://www.lifeweek.com.cn/article/251812",
    zh:{tag:"华语电影 · 评论", t:"姜文《你行！你上！》批评文章", d:"以批评视角进入姜文新作，谈作者风格与话语姿态。"},
  ...
  { date:"2025.07", url:"https://www.lifeweek.com.cn/article/251647",
    zh:{tag:"英国剧集 · 剧评", t:"英剧《悬案解码》第三季评论", d:"评这部 Netflix 英国剧集的第三季，谈悬案叙事与角色深度。"},
  ...
  { date:"2025.04", url:"https://www.lifeweek.com.cn/article/245602",
    zh:{tag:"日本电影 · 评论", t:"日本电影《黎明的一切》批评文章", d:"以批评视角进入这部日本电影，谈疾病、共处与温柔的日常。"},
...
const MAGAZINE = [
  ...
  { img:"/assets/magazine/mv-2025-12-task.jpg",
    zh:{show:"《特别小组》", plat:"HBO Max 剧集", issue:"《看电影》2025 年第 12 期"},
    en:{show:"Task", plat:"HBO Max series", issue:"Movieview, Issue 12, 2025"} },
...
const I18N = {
  zh: {
    ...
    "hero.title":"在银幕、舞台与文本之间，<br>写作与聆听。",
    "hero.lede":"我是杨祖占（Julian Yang），常驻上海的自由撰稿人与影视戏剧评论人。为《三联生活周刊》撰写长文，主理播客「袭击电影院」，往返于东亚、欧洲与好莱坞之间。这一页，让你在一次点击里知道我是谁、写什么、能一起做什么。",
    "hero.cta1":"看代表作品","hero.cta2":"谈合作",
    "hero.stat1.k":"发表长文","hero.stat1.v":"《三联生活周刊》27 篇",
    "hero.stat2.k":"写作语言","hero.stat2.v":"中文 · 英文",
    "hero.stat3.k":"深耕领域","hero.stat3.v":"东亚 · 欧洲 · 好莱坞影剧",
    "about.title":"个人简介",
    "about.p1":"我从电影与媒体研究出身，写作横跨影视批评、戏剧评论与文化观察。过去几年在《三联生活周刊》发表十余篇长文，多篇达到十万以上阅读，也负责过电影节报道与统筹。",
    "about.p2":"我关注艺术电影与独立创作，也追踪主流剧集与动画——从韩国、日本、香港的作者电影，到好莱坞奥斯卡话题作、Disney+ 韩剧与迪士尼动画，再到英国剧场与 NT Live。除了写字，我和另一位电影媒体人共同主理播客「袭击电影院」。",
    "about.p3":"中文是母语，英文可用于采访、写作与国际约稿。如果你在找一个能同时驾驭批评深度与传播语感、并能跨语言工作的合作者，我们大概能聊得来。",
    "about.tag1":"影视批评","about.tag2":"戏剧评论","about.tag3":"播客制作","about.tag4":"电影节报道","about.tag5":"跨语言约稿",
    "focus.title":"研究与写作方向",
    "focus.1.t":"东亚作者电影与剧集","focus.1.d":"韩国、日本、香港电影与剧集的作者性与产业脉络，从院线到 Disney+ 的评论追踪。",
    ...
    "focus.4.t":"戏剧与舞台影像","focus.4.d":"剧场作品、文学改编与 NT Live 等舞台影像，关注文本与舞台的转译。",
    "work.title":"代表作品",
    "work.intro":"精选近期具代表性的评论与解析。完整文章见下方「文章」列表。",
    "work.film":"影视评论","work.drama":"戏评",
    "work.readlink":"阅读全文 →",
    "writing.title":"文章",
    "writing.intro":"按时间排列的文章流，以《三联生活周刊》长文为主。此列表持续更新。",
    "writing.pub":"三联生活周刊",
    "print.title":"纸媒影评 · 《看电影》专栏",
    ...
    "podcast.desc":"两个从业多年的电影媒体人（祖占、唐朝三科唐）共同发起的一档播客节目。从文字到语言，用声音与对话，碰撞新的火花——聊电影、聊剧集、聊行业。",
    "podcast.apple":"Apple Podcast 收听 →","podcast.xyz":"小宇宙（扫码订阅）","podcast.guest":"邀我做嘉宾",
    "collab.title":"合作方式",
    "collab.1.t":"约稿 / 专栏","collab.1.d":"影视、戏剧、文化类长文与评论；可承接中文、英文选题。",
    ...
    "contact.title":"想一起做点什么？","contact.lede":"编辑约稿、嘉宾邀约、活动合作都欢迎来信。我通常一到两个工作日内回复。",
    "contact.email":"写信给我 · youngformovie@163.com","contact.note":"常驻上海 · 可远程与跨时区协作",
    "qr.xhs.n":"小红书 · 杨祖占","qr.xhs.d":"小红书号 5328275193 · 扫码找到我",
    "qr.wx.n":"公众号 · 祖占电影手册","qr.wx.d":"微信扫码，关注我的账号",
    "qr.xyz.n":"小宇宙 · 袭击电影院","qr.xyz.d":"长按 / 扫码订阅播客",
